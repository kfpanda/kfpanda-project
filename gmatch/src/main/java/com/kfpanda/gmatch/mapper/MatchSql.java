...
public class MatchSql {
	...
	public static final String FIELDS = "`id`,`createtime`,`name`,`holder`,`size`,`cycle`,`level`,`type`,`gid`,`code`,`intro`";
	public static final String SAVE_FIELD = "`createtime`,`name`,`holder`,`size`,`cycle`,`level`,`type`,`gid`,`code`,`intro`";
	public static final String BEAN_FIELD_NAME = "#{createTime},#{name},#{holder},#{size},#{cycle},#{level},#{type},#{gId},#{code},#{intro}";
